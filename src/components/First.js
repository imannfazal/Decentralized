    ...
    <>
      <div class="mx-[185px] inline-flex  mt-16 text-grey ">
        <span class="w-[700px] border border-grey border-opacity-20 rounded-sm px-5 mr-6 py-7">
          <span class="ml-[403px]  pb-[6px] text-grey">
            <Segmented
              options={["Daily", "Weekly", "Monthly", "Yearly"]}
              style={{ textColor: "#5f5f5f" }}
              antSeg="#5f5f5f"
            />
          </span>
          <span class="py-5">
        ...
        <span class="">
          <div class="flex justify-center text-grey text-4xl mb-3">
            Crypto Exchange
          </div>
          <div class="flex justify-center text-lg text-grey">
          ...
          <div class="border border-grey border-opacity-20 px-5 pt-9 pb-[68px] mt-6 rounded-sm">
            <Tabs defaultActiveKey="1">
              <Tabs.TabPane tab="Swap" key="1" style={{ color: "#5f5f5f" }}>
                ...
                <div class="text-blue text-[10px] bg-blue bg-opacity-20 ml-7 mt-0.5 mr-28 rounded-sm py-[1px] px-2 whitespace-pre">
                  Min amount: 0.00184853
                </div>
