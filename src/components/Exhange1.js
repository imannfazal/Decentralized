...
const Exchange1 = () => {
    ...
    //sending value to awaiting deposit
            ...
            <div class='h-[696px]' style={{ backgroundImage: `url(${bg})`, backgroundRepeat: "no-repeat", backgroundSize: 'cover' }} >
                ...
                <div class='mx-[170px] inline-flex  mt-16 text-grey '>
                    ...
                    <div class='border border-grey border-opacity-20 rounded-sm px-5 py-3 text-grey bg-white'>
                        ...
                        <div class='w-[186px] text-blue text-[10px] bg-blue bg-opacity-20 ml-[21px] mt-0.5 rounded-sm py-[1px] px-2 whitespace-pre'>Min amount:                   0.00184853</div>
                        ...
                        <span class='inline-flex ml-4'>
                            <Select
                                ...
                                onChange={handleChange}
                                <Option value="ada"><img alt='img' src={ada} class='w-6 inline pb-1 mr-1' />ADA</Option>
                                <Option value="btc"><img alt='imge'  src={btc} class='w-6 inline pb-1 mr-1' />BTC</Option>
                                <Option value="algo"><img alt='img' src={algo} class='w-6 inline pb-1 mr-1' />ALGO</Option>
                                <Option value="enj"><img alt='img' src={enj} class='w-6 inline pb-1 mr-1' />ENJ</Option>
                            </Select>
                        </span>
                        ...
                        <Link to='/Await' ><Button type="primary" style={{ width: 335, marginTop: 25 }} onClick={send} >Create and Exchange</Button></Link>
