...
const Earn = () => { 
    ...
    return (
        <>
            ...
            <div class='grid grid-col-6 md:gap-7 gap-3 md:ml-[106px] ml-4 md:py-6 py-3 border border-grey border-opacity-20 rounded-sm mt-4 md:px-6 px-3'>
                ...
                <div class='col-start-1 col-span-6 md:pl-4 text-grey md:text-xs text-[10px]'><div class="grid grid-cols-4 mb-[5px]">
            ...
            <div class='inline-flex justify-end border border-grey border-opacity-20 rounded-sm md:ml-8 ml-6 mr-8 mt-7 md:mt-0 pr-28 md:pr-0'>
