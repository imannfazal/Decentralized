    ...
    return (
        <header class="text-white sticky top-0 z-20">
            ...
            <div class="container mx-auto md:flex md:flex-wrap pt-6 pb-1 md:flex-row items-center bg-black ">
                <a class="flex title-font font-medium md:items-center text-gray-900 mb-4 md:mb-0">
                ...
                <a href="/*"><button class="inline-flex border rounded-full border-white py-1 px-3 text-xs text-white md:ml-[456px] mt-4 mr-1 md:mt-0">indexx.ai</button></a>
                <button class="inline-flex items-center border rounded-full border-white py-1 px-3 text-xs text-white mt-4 md:mt-0">Connect Wallet</button>
            </div>
            </div>
        </header>
    );
