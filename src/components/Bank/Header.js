        ...
        <header class="text-white sticky top-0 z-20">
            <div class="bg-blackbg h-[70px]">
                <div class="container mx-auto md:flex md:flex-wrap pt-6 pb-1 md:flex-row items-center bg-black ">
                    ...
                    <button class="inline-flex border rounded-full border-lgreen hover:border-green py-0.5 px-3 text-xs hover:text-green text-lgreen md:ml-[600px]  mr-5 md:mt-0 mb-5"><a href="/*" class='text-lgreen'>indexx.ai</a></button>
