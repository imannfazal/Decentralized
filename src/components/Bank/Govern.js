...
const Govern = () => {
    return (
        <>
            <Header />
            <div class="md:text-xl text-lg font-bold text-all md:pl-16 pl-6 md:pr-6 pr-8 pt-6 md:mr-48 ">GOVERNANCE</div>
            <div class=''>
                <span class="inline-grid grid-col-3 gap-2 flex justify-start border border-grey border-opacity-20 rounded md:ml-16 ml-6 mb-9 md:mb-0 px-7 md:px-0" >
                    <div class='md:text-xs text-[10px] font-normal md:pl-9 md:pt-9 pt-4 pb-4'>iNDEXX PRICE</div> 
                    <div class='md:pl-9 md:pb-9 pb-4'><span class='md:text-2xl text-lg font-medium'>1.755</span> <span class='text-lg'>iUSD+</span></div>
                    ...
                    <div class='md:pl-9  md:pb-9 pb-6'><span class='md:text-2xl text-lg font-medium'>38.47M</span> <span class='text-lg pr-40'>indexx</span></div>
                </span>
                <span class='inline-grid grid-col-3 gap-2 pb-12 border border-grey border-opacity-20 rounded md:ml-8 mb-4 md:pr-9 ml-6 mr-6 md:mr-0'>
                    <div class='flex justify-center col-start-1 col-span-3 text-2xl text-all pt-9'><img src={img} width="80"></img></div>
                    <div class='flex justify-center col-start-1 col-span-3 md:text-2xl text-lg text-all py-9'>iNDEXX BANK (iNEX)</div>
                    <div class=' col-start-2 text-all md:pl-9 pb-6'><span class='md:text-xs text-[10px] border border-grey border-opacity-20 rounded py-1 px-4 bg-white'>APR</span> <span class='text-sm'>0.11 %</span></div>
                ...
                <a href='/Provide'><span class='inline-grid grid-col-3 gap-2 pb-12 border border-grey border-opacity-20 rounded md:ml-8 ml-6 mr-6 md:mr-0 mb-4 md:pr-28 hover:bg-light px-20'>
                    <div class='flex justify-center col-start-1 col-span-3 md:text-2xl text-lg text-all pt-9 md:pl-6'><img src={img} width="80"></img></div>
                    <div class='flex justify-center col-start-1 col-span-3 md:text-2xl text-lg text-all py-9 md:pl-6'>iNEX-USD LP {'>'}  </div>
            ...
            <div class="container mx-auto flex flex-wrap pt-6 pb-1 flex-col md:flex-row items-center bg-black md:text-sm text-xs">
                <div class="pt-6 md:mr-64 md:pr-16 justify-end"><a href='https://forum.anchorprotocol.com/'><button class='border border-grey border-opacity-20 bg-green text-white px-9 py-1 hover:bg-hovergreen rounded mr-3'>Join Forum</button></a><a href='/Poll'><button class='border border-grey border-opacity-20 py-1 px-9 rounded hover:bg-lighthover text-all rounded'>Create Poll</button></a></div>
            </div>
        </>
    );
}
