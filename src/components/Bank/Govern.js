    ...
    return (
        <>
            ...
            <div class='inline-flex mt-5'>
                <span class="grid grid-col-3 gap-2 border border-grey border-opacity-20 rounded md:ml-[104px]   mb-6 md:mb-6 px-7 md:px-0 " >
                    <div class='md:text-xs text-[10px] font-normal md:pl-9 md:pt-12 pt-4 pb-4'>iNDEXX PRICE</div>
                    ...
                    <div class='col-start-1 col-span-full border-t border-grey border-opacity-20'><div class='md:text-xs text-[10px] font-normal  md:pl-9 md:pt-12 pt-4 pb-4'>TOTAL STAKED </div></div>
                ...
                <span class='grid grid-col-3 gap-2 pb-12 border border-grey border-opacity-20 rounded md:ml-8 mb-4 md:pr-9 ml-6 mr-6 md:mr-0'>
                ...
                <a class='text-grey' href='/Provide'><span class='grid grid-col-3 gap-2 pb-12 border border-grey border-opacity-20 rounded md:ml-8 ml-6 mr-6 md:mr-0 mb-4 md:pr-28 hover:bg-light px-20'>
