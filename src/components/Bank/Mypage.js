...
const Mypage = () => {
    ...
    <Header />
        ...
        <br/><span class="md:inline-grid grid grid-cols-4 md:gap-4 gap-2 md:ml-[96px] ml-4 md:mr-3 mr-4 border border-grey border-opacity-20 rounded-sm mt-2 pl-3 pr-14 py-4">
        ...
        <div class="text-sm font-medium text-grey md:pl-[96px] pl-4 pt-6  flex justify-start mt-2 pb-4">REWARDS</div>
        <div class='overflow-auto mr-4'>
        <table class="table-fixed border border-grey border-opacity-20 rounded md:ml-[96px] ">
        ...
        <div class="text-sm font-medium text-grey md:pl-[96px] pl-4 pt-6  flex justify-start mt-2 pb-4">EARN</div>
        <div class='overflow-auto mr-4'>
            
        <table class="table-fixed border border-grey border-opacity-20 rounded md:ml-[96px]">
        <tr>
            <td class='px-12 py-5'> </td>
            <td class='px-7 py-5'> </td>
            <td class='pl-8 pr-6 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            ...
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-6 py-5'> </td>
            <td class=' py-5'> </td>
            <td class='px-12 py-5 md:text-sm text-xs text-green'><a href="/Earn">Go To Earn {">"}</a></td>
        </tr>
        </table>
        </div>
        <div class="text-sm font-medium text-grey md:pl-[96px] pl-4 pt-6  flex justify-start mt-2 pb-4">BORROW</div>
        <div class='overflow-auto  mr-4'>
        ...
        <tr>
            ...
            <td class='md:px-12 py-5'> </td>
            <td class='md:px-12 py-5'> </td>
            <td class='px-12 py-5 md:text-sm text-xs'><a href="/Borrow">Go To Borrow {">"}</a></td>
        </tr>
        </table>
        </div>

        <div class="text-sm font-medium text-grey md:pl-[96px] pl-4 pt-6  flex justify-start mt-2 pb-4">GOVERN</div>
        <div class='overflow-auto mr-4'>
            
        <table class="table-fixed border border-grey border-opacity-20 rounded mb-24 md:ml-[96px]">
        <tr>
            <td class='px-12 py-5'> </td>
            <td class='px-7 py-5'> </td>
            <td class='px-7 py-5'> </td>
            ...
            <td class='md:px-12 py-5'> </td>
            <td class='px-12 py-5 md:text-sm text-xs'><a href="/Govern">Create Poll {">"}</a></td>
        </tr>
        </table>
        </div>
    </>
