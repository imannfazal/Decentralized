...
const Mypage = () => {
    ...
    <>
    <Header />
        <span class="md:text-2xl text-xl font-bold text-all md:pl-16 pl-4 pt-6 mr-56 flex justify-start">MY PAGE</span>
        <br/><span class="md:inline-grid grid grid-cols-4 md:gap-4 gap-2 md:ml-40 ml-4 md:mr-7 mr-4 border border-grey border-opacity-20 rounded mt-2 pl-3 pr-3 py-4">
            <span class="col-start-1 col-span-2 md:pl-4 pl-2 text-xs text-all pt-3">TOTAL VALUE
            </span>
            <span class="col-start-1 md:pl-4 pl-2 text-all"><span class='text-xl font-medium'>0</span> <span class='text-xs'>USD</span></span>
        ...
        <span class="md:inline-grid grid grid-cols-3 md:gap-4 gap-2 ml-4 md:mr-9 mr-4 border border-grey border-opacity-20 rounded mt-4 pl-3 pr-3 py-4 my-3 md:pl-7 md:pr-12">
            <span class="col-start-1 col-span-2 md:pl-4 pl-2 text-xs text-all pt-3">TOTAL CLAIMABLE REWARDS </span>
            <span class="col-start-1 md:pl-4 pl-2 text-all"><span class='text-xl font-medium'></span> <span class='text-xs text-light'>0 USD</span></span>
            <span class="col-start-1 md:pl-4 pl-2 text-xs text-all pt-9">indexx PRICE</span>
            <span class="col-start-1 md:pl-4 pl-2 text-all"><span class='text-xl font-medium'>2.94</span> <span class='text-xs'>USD</span></span>
        ...
        <div class="text-sm font-medium text-all md:pl-40 pl-4 pt-6  flex justify-start mt-2 pb-4">REWARDS</div>
        <div class='overflow-auto ml-4 mr-4'>
        <table class="table-fixed border border-grey border-opacity-20 rounded md:ml-36 ">
            <thead class='border-b border-grey border-opacity-20 md:text-xs text-[10px]'>
                <tr >
                    <th class='px-9 py-5'>Rewards Pool</th>
            ...
            <tbody class='md:text-sm text-xs'>
                <tr>
        ...
        <div class="text-sm font-medium text-all md:pl-40 pl-4 pt-6  flex justify-start mt-2 pb-4">EARN</div>
        <div class='overflow-auto ml-4 mr-4'>
        ...
        <tr>
            ...
            <td class='md:px-9 py-5'> </td>
            <td class='md:px-9 py-5'> </td>
            <td class='px-9 py-5 md:text-sm text-xs'><a href="/Earn">Go To Earn {">"}</a></td>
        </tr>
        </table>
        </div>
        <div class="text-sm font-medium text-all md:pl-40 pl-4 pt-6  flex justify-start mt-2 pb-4">BORROW</div>
        <div class='overflow-auto ml-4 mr-4'>
        ...
        <div class="text-sm font-medium text-all md:pl-40 pl-4 pt-6  flex justify-start mt-2 pb-4">GOVERN</div>
        <div class='overflow-auto ml-4 mr-4'>
