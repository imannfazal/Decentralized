...
const Footer = () => {
    return(
        ...
        <div class="relative h-[430px] w-full text-white">
            <div class='flex justify-end w-28 ml-[1338px] mt-64 mb-5 items-end'><img src={need}></img></div>
            ...
            <span class="flex justify-center items-center w-[100px] ml-16 mt-24"><img src={insta} width="25" class='mr-2' /><img src={red} width="25" class='mr-2'/><img src={yt} width="25" class='mr-2'/><img src={twi} width="25" /></span>
