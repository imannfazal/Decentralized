import lady from '../assets/Wales.png';
...
const Footer = () => {
    return(
        <>
        <div class="relative h-[450px] w-full text-white">
            <div class='flex justify-end w-28 ml-[1338px] mt-64 mb-9 items-end'><img alt='img' src={need}></img></div>
            <span class="absolute inset-x-0 bottom-0  w-full bg-blue">
            <span class="absolute bottom-0 right-0 w-[450px] h-[420px] pr-4"><img alt='img' src={lady}></img></span>
            <span class="flex justify-center items-center w-[100px] ml-16 mt-24"><img alt='img' src={insta} width="25" class='mr-3' /><img alt='img' src={red} width="25" class='mr-3'/><img alt='img' src={yt} width="25" class='mr-3'/><img alt='img' src={twi} width="25" /></span>
